...
CXXFLAGS = -stdlib=libstdc++ -std=gnu++11 -W -Wall -pedantic -Wpointer-arith -Wwrite-strings -Wno-long-long $(THREADSCXXFLAGS) 
# CPPFLAGS is for C Pre-Processor flags
CPPFLAGS =  $(THREADSCPPFLAGS)  -DU_HAVE_ATOMIC=0 
...
LDFLAGS = -lstdc++ -stdlib=libstdc++ $(RPATHLDFLAGS)
